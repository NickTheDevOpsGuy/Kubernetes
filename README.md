...
3. **[Lab 3 – Persistent Storage](labs/lab-2-deployments-services)** → Using Persistent Volumes & Claims.  
4. **[Lab 4 – Helm** → Packaging](labs/lab-3-persistent-storage) and deploying applications.  
